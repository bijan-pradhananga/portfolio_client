...
export const aboutInfo:AboutInfoType = {
    ...
    description: [
        ...
        "Outside of coding, I love music and football, and I play both guitar and piano. I also enjoy exploring new tech, working on side projects (especially AI-related), and continuously learning. Feel free to reach out if you want to chat or collaborate."
    ]
}